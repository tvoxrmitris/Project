...
";
        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item">
                    <a href="#" onclick="resetPage()">Chăm sóc da</a>
                </li>
            </ol>
        </nav>
        ...
        <div class="box-container">
            ...
            $select_products = mysqli_query($conn, "SELECT * FROM products WHERE status = 'Còn hàng' AND category_name = '3' $sort_query") or die('Truy vấn thất bại: ' . mysqli_error($conn));
            ...
            <form method="post" class="box">
                <div class="img-container">
                    ...
                    <a href="checkout_product.php?product_id=<?php echo $product_id; ?>" class="buy_now"
