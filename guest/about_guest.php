...
<body>
    ...
    <!-- <div class="banner">
        <div class="detail">
            ...
            <a href="../user/index.php">Trang chủ</a><span>/về chúng tôi</span>
        </div>
    </div> -->
    <div class="line2"></div>
    <div class="about-us">
        <div class="row">
            ...
            $image_names = array("about.jpg", "about1.jpg", "about2.jpg");
            ?>
            ...
            document.addEventListener("DOMContentLoaded", function() {
                ...
                dots.forEach(function(dot) {
                    dot.addEventListener('click', function() {
                        ...
                        // Ẩn tất cả các hình ảnh và bỏ đi lớp 'active' khỏi các điểm đánh dấu
                        var images = document.querySelectorAll('.imgshop');
                        ...
                        // Hiển thị hình ảnh tương ứng với điểm đánh dấu được nhấp và thêm lớp 'active' cho điểm đánh dấu đó
