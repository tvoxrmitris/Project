...
";
        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item">
                    <a href="#" onclick="resetPage()">Chăm sóc tóc</a>
                </li>
            </ol>
        </nav>
        ...
        <div class="box-container">
            ...
            $select_products = mysqli_query($conn, "SELECT * FROM products WHERE status = 'Còn hàng' AND category_name = '4' $sort_query") or die('Truy vấn thất bại: ' . mysqli_error($conn));
