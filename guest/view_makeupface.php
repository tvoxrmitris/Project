...
// Truy vấn tổng số sản phẩm có category_name là 2
$query = "SELECT COUNT(*) as total_products FROM products WHERE category_name = 2";
$result = mysqli_query($conn, $query) or die('Truy vấn thất bại: ' . mysqli_error($conn));
...
?>
        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item">
                    <a href="#" onclick="resetPage()">Trang điểm mặt</a>
                </li>
            </ol>
        </nav>
        ...
        function displayProduct($subcategory_name, $subcategory_image) {
            ...
            echo '<a href="http://localhost/NLCSN/guest/guest_subcategory.php?category=' . urlencode($subcategory_name) . '">';
            ...
            <div class="sort-by">
                <form method="get" action="">
                    ...
                    <select name="sort" id="sort" onchange="this.form.submit()">
                        ...
                        <option value="price_asc" <?php echo ($sort_by == 'price_asc') ? 'selected' : ''; ?>>Giá (Cao
                            đến thấp)</option>
                        <option value="price_desc" <?php echo ($sort_by == 'price_desc') ? 'selected' : ''; ?>>Giá (Thấp
                            đến cao)</option>
                    </select>
                </form>
            </div>
    ...
    $select_products = mysqli_query($conn, "SELECT * FROM products WHERE status = 'Còn hàng' AND category_name = '2' $sort_query") or die('Truy vấn thất bại: ' . mysqli_error($conn));
