...
<body>
    ...
    <section class="add-products form-container">
        <form method="POST" action="" enctype="multipart/form-data">
            <a style="font-size: 25px;" href="manage_product.php" class="back-arrow">&#8592;</a>

            <!-- Trường tìm kiếm -->
            <!-- <div class="input-field search-field">
                <label>Tìm sản phẩm</label>
                <input type="text" id="searchProduct" placeholder="Nhập tên sản phẩm..." oninput="showSuggestions()">
