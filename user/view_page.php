                ...
                <div class="product-details">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb1">
                            <li class="breadcrumb-item1"><a href="../user/index.php">Trang chủ</a></li>
                            <?php
                ...
                alt="' . htmlspecialchars($current_color_name) . '"/>';
                  ...
                  onclick="getProductInfo(\'' . addslashes($product_name) . '\', \'' . addslashes($color_name) . '\', ' . $color['product_id'] . ')">';
                    ...
                    function getProductInfo(productName, colorName, productId) {
                        ...
                        xhr.open("POST", "../user/get_color_info.php", true);
                        ...
                        xhr.onreadystatechange = function() {
                            if (xhr.readyState === 4 && xhr.status === 200) {
                                if (xhr.responseText === "found") {
                                    ...
                                    window.location.href = "view_page.php?product_id=" + productId;
                                } else {
        ...
        ") or die('Query failed: ' . mysqli_error($conn));
            ...
            document.addEventListener('DOMContentLoaded', function() {
                ...
                incrementButton.addEventListener('click', function() {
                    ...
                    hiddenQuantityField.value = quantity + 1;
                ...
                addToCartButton.addEventListener('click', function() {
                    ...
                    if (product_id) {
                        ...
                        fetch('add_to_cart_vp.php', {
                                method: 'POST',
                                headers: {
                                    'Content-Type': 'application/json'
                                },
                                body: JSON.stringify({
                                    product_id: prodct_id,
                                    quantity: quantity
                                })
                            })
                            .then(response => response.json())
                            .then(data => {
                                if (data.success) {
                                    // Xử lý thành công mà không cần thông báo
