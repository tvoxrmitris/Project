...
";
        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="../user/index.php">Trang chủ</a></li>
                <?php
...
";
                ...
                <div class="detail">
                    ...
                    <div class="color">
                        ...
                        <span class="shade" style="cursor: pointer;"
                            onclick="window.location.href='view_paget.php?product_id=<?php echo $product_id; ?>';">
            ...
            <?php
                ...
                echo '<p class="empty">Không có sản phẩm nào trong tầm giá này.</p>';
            }
            ?>
        </div>
